...
const certificates = [
    ...
    "../resources/certificates/Python_for_Beginners_E-Certificate.png", // UOM python beginner 
    "../resources/certificates/CD9S-94.png" // creative design workshop
];
...
function displayCertificates() {
    ...
    // Update the carousel position every 3 seconds
    setInterval(() => {
...
function updateCarousel() {
    ...
    carousel.classList.remove("animate"); // Reset animation
    void carousel.offsetWidth; // Trigger reflow to restart animation
    carousel.classList.add("animate"); // Apply animation
}
